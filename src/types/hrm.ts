 ...
 * Required fields: first_name, last_name, email, org_unit_id, position_id
 * employee_code is auto-generated by the service layer
 */
export interface HrmEmployeeCreatePayload {
  employee_code: string           // Auto-generated
  first_name: string
  last_name: string
  email: string
  phone: string | null
  org_unit_id: string             // Required for create
  position_id: string             // Required for create
  manager_id: string | null
  employment_status: EmploymentStatusType
  hire_date: string | null
  termination_date: string | null
