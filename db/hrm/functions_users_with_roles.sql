-- =============================================================================
-- HRM Phase 3 – Step 3.2: Secure RPC Function for User Management
-- Safely exposes auth.users with roles and linked employee data
-- =============================================================================
...
-- Frontend access control limits visibility to Admin/HR Manager only
